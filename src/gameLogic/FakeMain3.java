...
public class FakeMain3 extends SimpleApplication {
    ...
    public void simpleInitApp() {
        ...
        heroScene = (Node) assetManager.loadModel("Zombie.scene");
        heroScene.setLocalScale(.025f);
        heroScene.setLocalTranslation(-1000f, -1000f, -1000f);
